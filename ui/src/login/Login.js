...
export function Login(props) {
    ...
    async function onSignupSubmit(e) {
        ...
        if(validateSignup()) {
            ...
            // while in pending state, display a spinny loader in the form

            // on success, display user successfully added notification

            // on failure, display appropriate error notification
